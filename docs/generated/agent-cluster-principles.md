...
| failure-conditions | Operational breakage signal | Blocked authority, recovery, and learning loop | The system defines how it is failing, not only how it succeeds. |
