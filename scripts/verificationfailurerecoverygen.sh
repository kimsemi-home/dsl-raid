...
validate_recovery() {
  PYTHONDONTWRITEBYTECODE=1 python3 "$repo/scripts/lib/failure_recovery_check.py" \
    "$repo/$out" "$repo/docs/generated/verification-failure-conditions.json" \
    "$repo/docs/generated/verification-incident-learning.json" \
    "$repo/docs/generated/verification-learning-loop.json" \
    "$repo/docs/generated/verification-evidence.json" "$repo"
}
