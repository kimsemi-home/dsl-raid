...
errors, seen = [], set()
required = {"privacy-exclusion", "autonomous-merge", "source-shape", "backend-projection", "codegen-chain", "pdca-learning", "actions-receipt", "query-lazy-surface", "learning-loop", "local-precommit"}
