(defpackage #:dslraid.ir
  ...
  (:export
   ...
   #:guard #:make-guard #:guard-id #:guard-kind #:guard-expression #:guard-input #:guard-defined-at #:guard-tags #:action #:make-action #:action-id #:action-kind #:action-command #:action-emits #:action-expression #:action-defined-at #:action-tags
