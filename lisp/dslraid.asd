  ...
  ((:module "packages"
   ...
   (:module "agent"
    ...
    ((:file "package") (:file "principles") (:file "markdown")
     ...
     (:file "verification_privacy") (:file "verification_public_projection") (:file "verification_pdca")
     (:file "verification_evidence_ops") (:file "verification_evidence_graph") (:file "verification_evidence_graph_emit") (:file "verification_loss")
     ...
     (:file "verification_evidence_quality_registry") (:file "verification_evidence_quality_registry_tail") (:file "verification_evidence_quality_registry_tail_compiler") (:file "verification_evidence_quality_registry_tail_abort") (:file "verification_evidence_quality_registry_tail_pdca") (:file "verification_evidence_quality_registry_tail_confidence") (:file "verification_evidence_quality_registry_tail_merge") (:file "verification_evidence_quality_registry_tail_graph") (:file "verification_evidence_quality_registry_tail_public") (:file "verification_evidence_quality_registry_tail_extra")
     (:file "verification_semantic_hash") (:file "verification_semantic_diff")
     (:file "verification_authority") (:file "verification_access_policy") (:file "verification_reasoning_access") (:file "verification_reliability") (:file "verification_agreement") (:file "verification_adversarial_review") (:file "verification_evidence_quality") (:file "verification_abort_evidence") (:file "verification_lease") (:file "verification_lease_rules") (:file "verification_review_capacity") (:file "verification_review_capacity_rules") (:file "verification_feedback") (:file "verification_feedback_rules") (:file "verification_quarantine") (:file "verification_quarantine_rules") (:file "verification_quarantine_release") (:file "verification_quarantine_release_tail") (:file "verification_confidence") (:file "verification_confidence_decision")
     (:file "verification_sidecar") (:file "verification_orchestration") (:file "verification_control_plane") (:file "verification_shadow_orchestrator") (:file "verification_provider_compat") (:file "verification_runtime_trace") (:file "verification_runtime_contract") (:file "verification_domain_fsm") (:file "verification_semantic_os") (:file "verification_semantic_os_emit") (:file "verification_operating_loop") (:file "verification_operating_loop_tail") (:file "verification_operating_loop_close") (:file "verification_operating_loop_emit") (:file "verification_query_surface") (:file "verification_run_manifest")
     (:file "verification_bootstrap_sequence") (:file "verification_experiment_loop") (:file "verification_experiment_decision") (:file "verification_merge_readiness") (:file "verification_merge_automation") (:file "verification_branch_protection") (:file "verification_actions_receipt") (:file "verification_merge_receipt") (:file "verification_source_shape") (:file "verification_objective_coverage") (:file "verification_objective_coverage_emit") (:file "verification_adr_governance") (:file "verification_backend_parity") (:file "verification_execution_projection") (:file "verification_github_actions") (:file "verification_workflow_lineage") (:file "verification_release_provenance") (:file "verification_incident_learning") (:file "verification_governed_compiler") (:file "verification_governed_compiler_emit") (:file "verification_learning_loop") (:file "verification_learning_loop_emit") (:file "verification_executable_knowledge") (:file "verification_executable_knowledge_emit") (:file "verification_knowledge_conversion") (:file "verification_knowledge_conversion_tail") (:file "verification_knowledge_conversion_emit") (:file "verification_quality_closure") (:file "verification_precommit_closure")
     (:file "verification_genesis_charter") (:file "verification_meta_model") (:file "verification_backup_steward") (:file "verification_revalidation_gate") (:file "verification_cold_start_gate") (:file "verification_evidence_separation") (:file "verification_evidence_before_change") (:file "verification_versioned_ssot") (:file "verification_bounded_context") (:file "verification_migration_surface") (:file "verification_language_expansion") (:file "verification_context_map") (:file "verification_translation_verifier") (:file "verification_historical_interpreter") (:file "verification_ontology_transition") (:file "verification_ssot_defect") (:file "verification_root_cause") (:file "verification_semantic_debugger") (:file "verification_pruning") (:file "verification_security_audit") (:file "verification_failure_conditions") (:file "verification_failure_recovery") (:file "verification_debt") (:file "verification_incompleteness_ledger")
