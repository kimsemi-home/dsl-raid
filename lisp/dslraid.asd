  ...
  ((:module "packages"
   ...
   (:module "agent"
    ...
    ((:file "package") (:file "principles") (:file "markdown")
     ...
     (:file "verification_workflow_names") (:file "verification_workflow") (:file "verification_gitlab")
