  ...
  ((:module "packages"
   ...
   (:module "agent"
    ...
    ((:file "package") (:file "principles") (:file "markdown")
     ...
     (:file "verification_sidecar") (:file "verification_orchestration") (:file "verification_control_plane") (:file "verification_provider_compat") (:file "verification_runtime_trace") (:file "verification_query_surface") (:file "verification_run_manifest")
