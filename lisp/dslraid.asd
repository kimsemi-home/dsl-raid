  ...
  ((:module "packages"
   ...
   (:module "agent"
    ...
    ((:file "package") (:file "principles") (:file "markdown")
     (:file "verification_release_checks") (:file "verification") (:file "verification_backends") (:file "verification_accessors")
     ...
     (:file "verification_privacy") (:file "verification_pdca") (:file "verification_loss") (:file "verification_semantic_hash_registry") (:file "verification_semantic_diff_registry") (:file "verification_evidence_quality_registry") (:file "verification_semantic_hash") (:file "verification_semantic_diff") (:file "verification_authority") (:file "verification_access_policy") (:file "verification_reliability") (:file "verification_evidence_quality") (:file "verification_lease") (:file "verification_lease_rules") (:file "verification_review_capacity") (:file "verification_review_capacity_rules") (:file "verification_feedback") (:file "verification_feedback_rules") (:file "verification_quarantine") (:file "verification_quarantine_rules") (:file "verification_confidence") (:file "verification_sidecar") (:file "verification_orchestration") (:file "verification_evidence_before_change") (:file "verification_versioned_ssot") (:file "verification_context_map") (:file "verification_historical_interpreter") (:file "verification_ontology_transition") (:file "verification_ssot_defect") (:file "verification_root_cause") (:file "verification_semantic_debugger") (:file "verification_pruning") (:file "verification_security_audit") (:file "verification_failure_conditions") (:file "verification_debt")
