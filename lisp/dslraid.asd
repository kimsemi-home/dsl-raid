  ...
  ((:module "packages"
   ...
   (:module "agent"
    ...
    ((:file "package") (:file "principles") (:file "markdown")
     ...
     (:file "verification_evidence_quality_registry") (:file "verification_evidence_quality_registry_tail") (:file "verification_evidence_quality_registry_tail_compiler") (:file "verification_evidence_quality_registry_tail_abort") (:file "verification_evidence_quality_registry_tail_extra")
