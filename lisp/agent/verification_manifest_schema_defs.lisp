...
(defun verification-manifest-schema-defs-json ()
  (concatenate
   ...
   "\"evidence_quality\":{\"type\":\"object\",\"required\":[\"id\",\"target\",\"quality\",\"purpose\",\"assessed_by\",\"signals\",\"meaning\"],\"additionalProperties\":false,\"properties\":{\"id\":{\"$ref\":\"#/$defs/semantic_ref\"},\"target\":{\"$ref\":\"#/$defs/path\"},\"quality\":{\"enum\":[\"high\",\"medium\",\"low\"]},\"purpose\":{\"type\":\"string\",\"minLength\":1},\"assessed_by\":{\"$ref\":\"#/$defs/semantic_ref\"},\"signals\":{\"$ref\":\"#/$defs/strings\"},\"meaning\":{\"type\":\"string\",\"minLength\":1}}}}"))
