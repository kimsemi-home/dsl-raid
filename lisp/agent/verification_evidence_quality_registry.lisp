...
(defparameter *verification-evidence-quality-core-assessments*
  '(("evidence-quality:generated-evidence" "docs/generated/verification-evidence.json" "high" "release-check" "gate:evidence-quality" ("generated_backends" "verification_nodes") "Generated backend inventory is suitable for conformance checks.")
    ...
    ("evidence-quality:run-manifest" "docs/generated/verification-run-manifest.json" "high" "run-manifest" "gate:evidence-quality" ("records" "closure_rules") "Run manifest evidence is suitable when schema and generated docs agree.")
    ...
    ("evidence-quality:github-actions-suite" "docs/generated/verification-github-actions.json" "high" "github-actions-suite" "gate:evidence-quality" ("workflows" "closure_rules") "GitHub Actions suite evidence is suitable when ownership and permissions are explicit.")
    ("evidence-quality:release-provenance" "docs/generated/verification-release-provenance.json" "high" "release-provenance" "gate:evidence-quality" ("gates" "closure_rules") "Release provenance evidence is suitable when promotion gates are explicit.")
