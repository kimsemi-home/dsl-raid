...
(defparameter *verification-codegen-axes*
  '("code" "docs" "schemas" "tests" "conformance"
    "github-actions" "release-pipelines" "bootstrap-sequence" "experiment-loop" "merge-readiness" "merge-automation" "branch-protection" "pdca-evidence" "evidence-ops" "loss-ledger"
